...
function processFile(inputFilename, outputFilename, caesarKey, vigenereKey, vernamKey, encrypt) {
    try {
                ...
                rl.question('Enter the Caesar Cipher key (1 to 25): ', (caesarKey) => {
                    ...
                    rl.question('Enter the Vigenere Cipher key: ', (vigenereKey) => {
                        ...
                        rl.question('Enter the Vernam Cipher key: ', (vernamKey) => {
                            ...
                            processFile(inputFilename, outputFilename, caesarKey, vigenereKey, vernamKey, isEncrypt);
                            rl.close();
                        });
                    });
                });
